...
export class ForecasProcessingInternalError extends InternalError {
...
export class Forecast {
  ...
  public async processForecastForBeaches(
    ...
    try {
      ...
      return this.mapForcastByTime(pointWithCorrectSources);
    } catch (error) {
      throw new ForecasProcessingInternalError((error as Error).message);
    }
  }
